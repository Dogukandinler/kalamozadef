...
function App() {
    ...
    const checks = [
        { id: "1",company:"", date: new Date(2022, 1, 6),  explanation:"Orospu cocuklarına hayır parası" ,debtclaim:100,debtBlance:"",claimBlance:"",SelectionCD:"Borç"},
        ...
        { id: "5",company:"", date: new Date(2022, 3, 11), explanation:"Satış" ,debtclaim:600, debtBlance:"",claimBlance:"",SelectionCD:"Alacak"},

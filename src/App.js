...
const DUMMY_CHECKS=[
    { id: "1",company:"", date: new Date(2022, 1, 6),  explanation:"...." ,debtclaim:300,debtBlance:"",claimBlance:"",selection:"Borç"},
        ...
        { id: "3",company:"", date: new Date(2020, 2, 13), explanation:"Alışveriş" ,debtclaim:100,debtBlance:"",claimBlance:"",selection:"Borç"},
        { id: "4",company:"", date: new Date(2019, 2, 24), explanation:"Ödeme" ,debtclaim:300,debtBlance:"",claimBlance:"",selection:"Borç"},
        { id: "5",company:"", date: new Date(2022, 3, 11), explanation:"Satış" ,debtclaim:500, debtBlance:"",claimBlance:"",selection:"Alacak"},
        ...
        { id: "9",company:"", date: new Date(2022, 3, 20), explanation:"Satış" ,debtclaim:600, debtBlance:"",claimBlance:"",selection:"Alacak"},
        { id: "10",company:"", date: new Date(2021, 3, 28), explanation:"Satış" ,debtclaim:600, debtBlance:"",claimBlance:"",selection:"Alacak"},
        { id: "11",company:"", date: new Date(2020, 6, 28), explanation:"Satış" ,debtclaim:600, debtBlance:"",claimBlance:"",selection:"Alacak"},
        { id: "12",company:"", date: new Date(2020, 3, 28), explanation:"Satış" ,debtclaim:600, debtBlance:"",claimBlance:"",selection:"Alacak"},
